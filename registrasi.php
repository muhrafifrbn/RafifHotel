  ...
  <body>
    <div>
      ...
      <form action="cek_registrasi.php" method="post">
        ...
        <input type="text" id="namaLengkap" name="namaLengkap" placeholder="Masukkan Nama Lengkap Anda.." />
        <label for="password">Password</label>
        <input type="password" id="password" name="password" placeholder="Masukkan Password Anda.." />
        <label for="password2">Password</label>
        <input type="password" id="password2" name="password2" placeholder="Konfirmasi Password Anda.." />
